...
use atomic_sync::mutex::embedded::{SpinningMutex, TrMutexSignal};
use mm_ptr::x_deps::{abs_sync, atomex, atomic_sync};
use pincol::linked_list::{PinnedList, PinnedSlot};
...
/// `oneshot::Oneshot` channel is capable and only capable of a sending and 
